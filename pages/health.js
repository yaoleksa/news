...
class HealthNavbarMenu extends React.Component {
    render() {
        return (
        ...
        <Container fluid>
          ...
          <Navbar.Collapse id="navbarScroll">
            ...
            >
              ...
              <Nav.Link className="navbar_link" href="./health.html" active>Здоров'я</Nav.Link>
...
class HealthFooter extends React.Component {
  render() {
    return (
      <div id="footer">
        <Container>
